...
namespace ESH.ReaisPorExtenso
{
    /// <summary>
    /// Classe que realiza conversão de valores para extenso
    /// </summary>
    public class Conversor : IConversor
    {
        ...
        public string ConverteParaExtenso(decimal valor)
        {
            Validar(valor);
        ...
        private void Validar(decimal valor)
        {
            ...
            {
                throw new ArgumentException("Valor não suportado para conversão");
            }
        }
